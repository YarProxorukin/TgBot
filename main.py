...
db = sqlite3.connect('Manakova_bot.db')
cursor = db.cursor()
...
bot = Bot(token='7021840732:AAEh_1Vak-u_cQhOhpezntcZEX4NnRkNKcU')
...
async def user_data(message: types.Message):
    ...
    conn = sqlite3.connect('Manakova_bot.db')
    cursors = conn.cursor()
